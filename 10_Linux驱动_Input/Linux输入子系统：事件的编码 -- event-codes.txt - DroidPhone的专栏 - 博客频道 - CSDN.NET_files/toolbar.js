    ...
    Toolbar.prototype = {
      ...
      */
      ...
      bindEvent: function(opts) {
        ...
        this.Doms.listBtns.bind('mouseover', function(event) {
          ...
          if($(event.target).hasClass("notify")){
            opts.notifyInst&&$(document).trigger("toolbar-setNotesNum",opts.notifyInst.unreads);
      ...
      initNotify : function(opts){
        ...
        opts.notifyInst&&opts.notifyInst.on("receive_unreads",function(e,data){
          var num = opts.notifyInst.unreads||data;
